    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      credential = MongoCredential.createCredential("sampleUser", "cms_database", 
         "password".toCharArray());
            ...
            MongoCollection<Document> collection = database.getCollection("user_account_section");
            String uname=request.getParameter("user");
            String passwd=request.getParameter("pass");
            List obj = new ArrayList();
            obj.add(new BasicDBObject("username", uname));
            obj.add(new BasicDBObject("password", passwd));
            ...
            {
                out.print("<h2 align='center'>Sorry!Username or Password Error!</h2>");
